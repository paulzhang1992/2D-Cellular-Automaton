...
public class MenuManager implements ActionListener {
	 ...
	 */
	public MenuManager(AppFrame application) {
	 ...
	 */
	public MenuManager(AppFrame application, String text) {
		this.application = application;
		this.text=text;
		this.id = "menu-" + Integer.toString(counter++);
		init();
	 ...
	 */
	public MenuManager(AppFrame application, String text, String id) {
		this.application = application;
		this.text = text;
		this.id = id;
		init();
	...
	public void createDefaultActions() {
		...
		JMenu fileMenu = addMenu(menuBar,"core.file", "Exit", 'E', "File Menu Actions");
	...
	class ExitAction extends AbstractAction {
		...
		protected ExitAction(AppFrame application) {
			super("ExitAction");
			this.application = application;
		}
	...
	class AboutAction extends AbstractAction {
		...
		protected AboutAction(AppFrame application) {
			super("AboutAction");
			this.application = application;
		}
